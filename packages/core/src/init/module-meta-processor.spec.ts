...
import { UnknownExport, ForbiddenNormalizedExport, ForbiddenAppExport, ReexportFailure, UndefinedSymbol } from '#error/core-errors.js';
...
describe('ModuleMetaProcessor', () => {
  ...
  // Tests moved to specialized processors: extensions-processor.spec.ts, imports-exports-processor.spec.ts
