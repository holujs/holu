...
Holu is a Node.js-based web framework designed for building highly extensible and fast applications. *Holu* is a Hawaiian word for "to move, to stir into motion" — and that's the idea behind this framework: **set your server-side applications in motion** on Node.js, powered by DI, TypeScript, and true modularity.
