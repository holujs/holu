...
3. **Aspect Decorator Execution**: If a module uses extended aspect decorators (such as `@restModule` or custom `@mixin*`), corresponding module aspects are executed to normalize extended metadata.
