...
Holu - це веб-фреймворк на базі Node.js, призначений для створення добре-розширюваних та швидких застосунків. *Holu* - це гавайське слово, що означає «рух, пожвавлення» — і це ідея, що стоїть за цим фреймворком: **привести ваші серверні застосунки в рух** на Node.js, завдяки DI, TypeScript, та справжній модульності.
